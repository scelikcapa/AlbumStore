...
// MY CODE - added
builder.Services.AddDbContext<AlbumStoreDbContext>(options =>options.UseInMemoryDatabase("AlbumStoreDb"));
builder.Services.AddScoped<IAlbumStoreDbContext>(provider => provider.GetService<AlbumStoreDbContext>());
